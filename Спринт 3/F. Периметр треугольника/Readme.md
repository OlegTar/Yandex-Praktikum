...
Напомним, что из трёх отрезков с длинами 
a
≤
b
≤
c
a≤b≤c можно составить треугольник, если выполнено неравенство треугольника: 
c
<
a
+
...
,
2
6,3,3,2. Попробуем в качестве наибольшей стороны выбрать 
6
6. Неравенство треугольника не может выполниться, так как остались 
3
,
3
,
2
3,3,2 —– максимальная сумма из них равна 
6
6.
...
,
2
3,3,2. Неравенство выполняется: 
3
<
3
+
2
3<3+2. Периметр равен 
3
+
3
+
