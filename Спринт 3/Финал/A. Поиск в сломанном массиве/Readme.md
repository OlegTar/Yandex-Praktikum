...
k
k. Длина массива не превосходит 
10000
10000. Элементы массива и число 
k
k не превосходят по значению 
10000
10000.
...
k
k, если такой есть в массиве (нумерация с нуля). Если элемент не найден, функция должна вернуть 
−
1
−1.
