...
public class Solution {
    ...
    private static class HistoricalArray {
        private int currentEraId = 0;
        private List<Integer> eras = new ArrayList<>();
        ...
        public void set(int index, int value) {
            ...
            map.get(index).put(currentEraId, value);
        }
        ...
        public int get(int index, int eraId) {
            ...
            int index1 = eras.indexOf(eraId);

            for (int i = index1; i >= 0; i--) {
                int currEraId = eras.get(i);
                if (map.get(index).containsKey(currEraId)) {
                    return map.get(index).get(currEraId);
                }
            }
